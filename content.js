...
(function () {
  ...
  const HIGHLIGHT_ATTR = 'data-umb-devtools-highlight';
  ...
  function clearHighlight() {
    if (hoveredEl) {
      hoveredEl.removeAttribute(HIGHLIGHT_ATTR);
      hoveredEl = null;
    }
  }

  function injectHighlightStyle() {
    if (document.getElementById('__umb_devtools_style__')) return;
    const style = document.createElement('style');
    style.id = '__umb_devtools_style__';
    style.textContent = `
      [data-umb-devtools-highlight="true"] {
  ...
  function removeHighlightStyle() {
    const s = document.getElementById('__umb_devtools_style__');
    if (s) s.remove();
  }
